...
exports.up = function (knex) {
  return knex.schema.hasTable("encounters").then(function (exists) {
    ...
    return knex.schema.createTable("encounters", function (table) {
      ...
      table.bigInteger("appointment_id").unsigned().nullable().references("id").inTable("appointments").onDelete("SET NULL").onUpdate("CASCADE");
      ...
      table.enu("visit_type", ["onsite", "telemedicine", "walkin"], {
        useNative: false,
      ...
      table.enu("status", ["open", "closed", "signed"], {
        useNative: false,
