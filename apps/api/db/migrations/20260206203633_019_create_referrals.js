exports.up = function (knex) {
  return knex.schema.createTable("referrals", function (table) {
    ...
    table
      .enu("urgency", ["routine", "urgent", "stat"], {
        useNative: false,
    ...
    table
      .enu("status", ["pending", "accepted", "completed", "rejected", "cancelled"], {
        useNative: false,
