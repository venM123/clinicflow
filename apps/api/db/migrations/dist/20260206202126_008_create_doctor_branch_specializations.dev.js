...
exports.up = function (knex) {
  return knex.schema.createTable("doctor_branch_specializations", function (table) {
    ...
    table.bigInteger("specialization_id").unsigned().notNullable().references("id").inTable("specializations").onDelete("RESTRICT").onUpdate("CASCADE");
    ...
    table.unique(["doctor_id", "branch_id", "specialization_id"], "uq_dbs_doctor_branch_specialization");
